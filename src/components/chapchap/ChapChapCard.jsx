...
const ChapChapCard = ({ order, onPress }) => {
  ...
  const getStatusConfig = (status) => {
    // Convert to lowercase to handle both frontend casing and Prisma uppercase enums safely
  ...
  // Dynamically calculate total based on new schema fields
  ...
  return (
    <TouchableOpacity style={styles.card} onPress={onPress} activeOpacity={0.7}>
        ...
        <View style={styles.leftHeader}>
          <View style={styles.idContainer}>
            ...
            <Text style={styles.orderId}>
              CHAP-{order.id.slice(0, 6).toUpperCase()}
            </Text>
          </View>
      ...
      <View style={styles.body}>
        ...
        <Text style={styles.total}>UGX {displayTotal.toLocaleString()}</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  idContainer: { flexDirection: "row", alignItems: "center", gap: 4 },
  orderId: { fontSize: 14, fontWeight: "600", color: "#334155" },
  itemCount: { fontSize: 12, color: "#666666" },
  statusBadge: {
    flexDirection: "row",
    alignItems: "center",
    paddingHorizontal: 8,
  ...
  body: { gap: 4 },
  timeAgo: { fontSize: 12, color: "#999999" },
  locationRow: { flexDirection: "row", alignItems: "center", gap: 4 },
  location: { fontSize: 13, color: "#334155", flex: 1 },
  total: { fontSize: 15, fontWeight: "600", color: "#f59e0b", marginTop: 2 },
  footer: {
    marginTop: 8,
    paddingTop: 8,
    borderTopWidth: 1,
  ...
  viewDetails: { fontSize: 13, color: "#0ea5e9", fontWeight: "500" },
});
