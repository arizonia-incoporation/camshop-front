  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.hero}>
        ...
        <Text style={styles.tagline}>Everything Busitema needs, one app away🎉</Text>
      </View>

      <Image
        source={{ uri: 'https://images.unsplash.com/photo-1607082349566-187342175e2f?w=800' }}
        style={styles.image}
      />

      <View style={styles.actions}>
        <Button title="Create an account" variant="primary" onPress={() => navigation.navigate('Signup')} />
